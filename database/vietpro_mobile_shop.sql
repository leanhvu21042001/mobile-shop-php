...
--
-- Host: mysql_db
-- Generation Time: Jun 14, 2023 at 11:49 AM
...
--
CREATE DATABASE IF NOT EXISTS `vietpro_mobile_shop` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `vietpro_mobile_shop`;
...
CREATE TABLE `comment` (
  ...
  `comm_details` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `invoice` (
  ...
  `invoice_products` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `invoice_phone` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `invoice_address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product` (
  ...
  `prd_price` int UNSIGNED NOT NULL,
  `prd_warranty` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prd_accessories` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prd_new` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prd_promotion` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prd_status` int NOT NULL,
  `prd_featured` int NOT NULL,
...
(20, 7, 'OPPO R17 Pro Lavender', 'OPPO-R17-Pro-Lavender.png', 10000000, '12 Tháng', 'Hộp, sách, sạc, cáp, tai nghe', 'Máy Mới 100%', 'Dán Màn Hình 4D', 1, 0, 'Sản phẩm này chúng tôi đang cập nhật nội dung chi tiết, các bạn có thể qua trực tiếp cửa hàng để xem sản phẩm, vì hàng chúng tôi luôn có sẵn.'),
...
(29, 3, 'HTC widife', 'htc1.jpg', 1600000, 'khong', 'khong', 'con hang', ' khon', 1, 0, '<p>con hang</p>\r\n'),
(30, 3, 'HTC 14', 'tải xuống.jpg', 18000000, 'khong', 'khong', 'con hang', ' khong', 1, 0, '<p>con hang</p>\r\n'),
(31, 3, 'HTC 12', 'htc-u-20-5g-200820-050833-600x600.jpg', 2000000, 'khong', 'khong', 'con hang', 'khong', 1, 0, '<p>- Lặp tức theo d&otilde;i tiến tr&igrave;nh giao h&agrave;ng</p>\r\n\r\n<p>- Miễn ph&iacute; giao COD, hủy đơn, đổi trả 90 ng&agrave;y</p>\r\n\r\n<p>+ Đ&uacute;ng hẹn + cam kết ho&agrave;n tiền 100%</p>\r\n');
...
CREATE TABLE `user` (
  `user_id` int NOT NULL,
  `user_full` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Vietpro Academy', 'vietpro.edu.vn@gmail.com', '123', 1),
(2, 'Administrator', 'admin@gmail.com', '123456', 1),
(3, 'Nguyễn Van A', 'nguyenvana@gmail.com', '123456', 2),
(6, 'Phan Tan Dinh', 'admin@123.vn.com', '123', 1);
...
--
ALTER TABLE `comment`
  MODIFY `comm_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `product`
  MODIFY `prd_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
